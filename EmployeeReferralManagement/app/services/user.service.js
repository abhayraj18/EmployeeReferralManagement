...
var UserService = (function () {
    ...
    UserService.prototype.getLoggedInUser = function () {
        var _this = this;
        //alert("Hello : "+this.http.get('http://localhost:8080/EmployeeReferralManagement/rest/login/get-logged-in-employee'));
        this.http
            .get('http://localhost:8080/EmployeeReferralManagement/rest/login/get-logged-in-employee')
            .map(function (res) { return res.json(); })
            .subscribe(function (data) { return _this.data = data; }, function (err) { return _this.error = err; });
    };
